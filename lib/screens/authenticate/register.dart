...
class _RegisterState extends State<Register> {
  ...
  final ErrorHandling errorHandler = ErrorHandling();

  void changeShowRegister() => setState(() => showRegister = !showRegister);

  @override
  Widget build(BuildContext context) {
    SizeConfig().init(context);
    if (!showRegister) return SignIn();
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        TextFormField(
                          ...
                          validator: (v) =>
                              _validate.validatePassword(v?.trim()),
                          onChanged: (v) =>
                        ...
                        TextFormField(
                          ...
                          validator: (v) => _validate
                              .validateConfirmPassword(v?.trim(), _password),
                        ),
                            ...
                            onPressed: _isLoading
                                ...
                                : () async {
                                    ...
                                    try {
                                      ...
                                      setState(() => _error =
                                          errorHandler.errorHandling(e.code));
                                    } finally {
                                      if (mounted)
